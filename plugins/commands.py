...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Cʜᴀᴛ 💬', url=f'https://t.me/HelpDesk_XDs')
            ],[
            InlineKeyboardButton('Bᴏᴛꜱ Uᴘᴅᴀᴛᴇꜱ 🔈', url=f"https://t.me/+b5fixskSl981MDM1")
        ]]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("Bᴏᴛꜱ Uᴘᴅᴀᴛᴇꜱ 🔈", url="https://t.me/+b5fixskSl981MDM1")
            ],[      
            InlineKeyboardButton("Hᴇʟᴩ 🕸️", callback_data="help"),
            InlineKeyboardButton("Aʙᴏᴜᴛ ✨", callback_data="about")
        ]]
        m = await message.reply_sticker("CAACAgUAAxkBAAICTmUcLgM4noZXPZMe5IHCuKypeTVEAAJvCgACyltRVht3nqMEp-AAAR4E") 
        await asyncio.sleep(2)
